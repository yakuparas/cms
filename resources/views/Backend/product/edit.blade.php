                            ...
                            <div class="card card-outline card-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="name" name="name" value="{{$data->name}}" class="form-control" placeholder="Ürün Adı">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea  name="description" id="summernote" class="summernote">{{$data->description}}</textarea>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label class="col-form-label" for="inputSuccess">Durum</label><br>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input id="isvariants" disabled name="variants" class="form-control" data-on-text="Varyantlı" data-off-text="Varyantsız" type="checkbox"  data-toggle="switch">
                            ...
                            <div class="card card-outline card-primary pb-">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control"  name="meta_description" id="summernote" class="summernote">
                                            ...
                                            <div class=" priceinfo">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="form-group">
                                                            <label>Miktar</label>
                                                            <input type="number" value="{{$data->quantity}}" value="1" name="quantity" class="form-control">                                    </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$data->purchase_price}}" name="purchase_price" id="purchase_price" class="form-control">                                    </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="price" value="{{$data->price}}" id="price" class="form-control ">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="tax" value="{{$data->discount_price}}" id="" class="form-control">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$data->width}}" name="width" class="form-control">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$data->height}}" name="height" class="form-control">
