            ...
            @foreach($slide as $rs)
                <div>
                    <div class="home  text-center">
                        <img src="{{$rs->image}}" alt="" class="bg-img blur-up lazyload">
                        <div class="container">
                            <div class="row">
                                <div class="col">
...
@section('content')
    ...
    <div class="title1 section-t-space">
        <h2 class="title-inner1">{{__('site.soneklenenurunler')}}</h2>
    </div>
    ...
    <section class="p-0">
        <div class="full-banner parallax text-center p-left">
            <img src="{{asset("images/parallax.jpg")}}" alt="" class="bg-img blur-up lazyload">
            <div class="container">
                <div class="row">
                    <div class="col">
