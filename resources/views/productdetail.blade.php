                                    ...
                                    <div class="col-lg-6">
                                        <div class="product-right">
                                            <h2 id="pname">
                                                ...
                                                {{$isvariable?$variant->name:$data->name}}
                                            ...
                                            @php
                                                $price="";
                                                    if ($isvariable)
                                                        {
                                                            $price=is_null($variant->discount_price) ? $variant->price : $variant->discount_price;

                                                        }
                                                        else
                                                            {
                                                                $price=is_null($data->discount_price) ? $data->price : $data->discount_price;
                                                            }
                                            @endphp
                                            ...
                                            <h3 class="price-detail">{{$price}} EUR</h3>
                                                                    ...
                                                                    @foreach($variants as $rs)
                                                                        ...
                                                                        <div class="col-sm-3 pb-1">
                                                                            <div class="thumb-wrapper">
                                                                                <div class="img-box">
                                                                                    @php $price=is_null($rs->discount_price) ? $rs->price : $rs->discount_price; @endphp
                                                                                    <img data-pvid="{{$rs->id}}"  data-name="{{$rs->name}}" data-price="{{$price}}" data-img="{{$rs->image}}" src="{{$rs->image}}" width="100px" class="img-fluid" alt="">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                            ...
                                            <div class="product-buttons pt-2">
                                                ...
                                                <input type="hidden" name="pvid" id="pvid" value="">

                                                <button class="btn btn-solid hover-solid btn-animation" onclick="addcart({{$data->id}})">
...
@section('js')
    <script>
        ...
        function addcart(pid)
        {
            ...
            let pvid;
            if($("input[name=pvid]").val())
            {
                pvid=$("input[name=pvid]").val();
            }
            else
            {
                pvid=null;
